    ...
    <div style={{ fontFamily: fonts.base, color: colors.text, lineHeight: '1.6' }}>
      ...
      <header style={heroStyle}>
        ...
        <p style={{ fontSize: fontSizes.lg, maxWidth: '800px', margin: `0 auto ${spacing.lg}` }}>
          OrdoServus ist eine herunterladbare Software, die dich als Pfarrer, Diakon oder liturgischen Dienst bei der Vorbereitung
          deiner liturgischen Feier unterstützt. Online stehen Notizbuch und Kalender zur Verfügung.
        </p>
        <Link href="/login">
      ...
      <section style={cardsSectionStyle}>
        <Link href="/info/downloads" style={cardLinkStyle}>
          <div style={cardStyle}><h3>Downloads</h3><p>Herunterladbare Software für Desktop und Mobil.</p></div>
        </Link>
        <a href="https://ordoservus-wiki.vercel.app" target="_blank" rel="noopener noreferrer" style={cardLinkStyle}>
