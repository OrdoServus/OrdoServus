...
export default function Dashboard({ dokumente, onNeuNotiz }: DashboardProps) {
  ...
  return (
    <div style={s.container}>
      ...
      {/* Banner */}
      <div style={s.banner}>
        ℹ️ OrdoServus ist eine herunterladbare Software. Diese Online-Version bietet Notizbuch und Kalender, damit du sie immer dabei hast.{' '}
        <Link href="/info/downloads" style={s.bannerLink}>Mehr erfahren</Link>
      </div>
      ...
      <footer style={s.footer}>
        ...
        <div style={s.footerLinks}>
          ...
          <a
            href="https://github.com/ordoservus/ordoservus"
            target="_blank"
